...
import 're_popup_model.dart';
export 're_popup_model.dart';

class RePopupWidget extends StatefulWidget {
  const RePopupWidget({super.key});

  @override
  State<RePopupWidget> createState() => _RePopupWidgetState();
}

class _RePopupWidgetState extends State<RePopupWidget> {
  late RePopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RePopupModel());
